...
const Sidebar = () => {
  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        <button onClick={()=> navigate('/')} className='flex items-center gap-2 mb-6  cursor-pointer'>
          <img src={assets.arrow_icon} alt="" className='inline absolute z-10 left-4 top-4 rotate-180 opacity-65'/>
          <p className='z-10 absolute left-10 top-3 inline opacity-65 '>Home</p>
        </button>
        <br />
