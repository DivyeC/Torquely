...
const  { changeRole, isOwner, navigate } = useAppContext()
  ...
  return (
    ...
    className=' h-[16rem] flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
        ...
        src={assets.gtr_image} alt="car" className='max-w-120 object-fill -mt-14   right-35 -bottom-355'/>
